...
const imageSources = [
  "./images/magafrens-1.jpg",
  "./images/magafrens-2.jpg",
  "./images/magafrens-3.jpg",
  "./images/magafrens-4.jpg",
  "./images/magafrens-5.jpg",
  "./images/magafrens-6.jpg",
  "./images/magafrens-7.jpg",
  "./images/magafrens-8.jpg",
  "./images/magafrens-9.jpg",
];
        ...
        <div className="last flex max-md:flex-col wrapWidth ">
          ...
          <div className="flex-1 last-box max-md:mt-5">
            <div className="mt-16 max-md:my-16">
              ...
              <a href="https://t.me/FractalonPulse" className="icon">
              <button className="btn">Join Fractal Telegram</button>
            </a>
            </div>
          </div>
        </div>
